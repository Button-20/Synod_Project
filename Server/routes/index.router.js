...
router.get(
  ...
  ctrlRegistrant.getAllCount
);
router.get(
  "/registrant/ministerscountall",
  jwtHelper.verifyJwtToken,
  ctrlRegistrant.getPositionMinisterCount
);
router.get(
  "/registrant/laycountall",
  jwtHelper.verifyJwtToken,
  ctrlRegistrant.getPositionLayCount
);
router.get(
  "/registrant/visitorscountall",
  jwtHelper.verifyJwtToken,
  ctrlRegistrant.getPositionVisitorsCount
);
router.get(
  "/registrant/delegatecountall",
  jwtHelper.verifyJwtToken,
  ctrlRegistrant.getCategoryDelegateCount
);
router.get(
  "/registrant/observercountall",
  jwtHelper.verifyJwtToken,
  ctrlRegistrant.getCategoryObserverCount
);
...
router.get(
  "/user/allattendancedatefilter/:startdate/:enddate",
  ctrlAttendance.getAllAttendanceDateFilter
);
router.get(
  "/user/attendance/classname/:classname",
  ctrlAttendance.getClassname
);
