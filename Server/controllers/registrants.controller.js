...
module.exports.authenticate = (req, res, next) => {
  ...
  passport.authenticate("local", (err, Registrant, info) => {
    ...
    // registered Registrant
      ...
      return res.status(200).json({ token: Registrant.generateJwt() });
...
module.exports.get = (req, res) => {
  Registrant.find((err, docs) => {
    if (!err) {
      ...
      console.log(
        "Error in retrieving Registrants :" + JSON.stringify(err, undefined, 2)
      );
    }
  });
};
...
module.exports.getAllCount = (req, res) => {
  Registrant.countDocuments({}, (err, docs) => {
    if (!err) {
      ...
      console.log(
        "Error in retrieving Members Count :" +
...
module.exports.getPositionMinisterCount = (req, res) => {
  Registrant.countDocuments({ position: "Minister" }, (err, docs) => {
    if (!err) {
      ...
      console.log(
        "Error in retrieving Ministers Count :" +
          JSON.stringify(err, undefined, 2)
      );
    }
  });
...
module.exports.getPositionLayCount = (req, res) => {
  Registrant.countDocuments({ position: "Lay" }, (err, docs) => {
    if (!err) {
      ...
      console.log(
        "Error in retrieving Lay Count :" + JSON.stringify(err, undefined, 2)
      );
    }
  });
};
...
module.exports.getPositionVisitorsCount = (req, res) => {
  Registrant.countDocuments({ position: "Visitor" }, (err, docs) => {
    if (!err) {
      ...
      console.log(
        "Error in retrieving Visitors Count :" +
          JSON.stringify(err, undefined, 2)
      );
    }
  });
...
module.exports.getCategoryDelegateCount = (req, res) => {
  Registrant.countDocuments({ category: "Delegate" }, (err, docs) => {
    if (!err) {
      ...
      console.log(
        "Error in retrieving Delegate Count :" +
          JSON.stringify(err, undefined, 2)
      );
    }
  });
...
module.exports.getCategoryObserverCount = (req, res) => {
  Registrant.countDocuments({ category: "Observer" }, (err, docs) => {
    if (!err) {
      ...
      console.log(
        "Error in retrieving Observer Count :" +
          JSON.stringify(err, undefined, 2)
      );
    }
  });
...
module.exports.getID = (req, res) => {
  if (!ObjectId.isValid(req.params.id))
    return res
      .status(400)
      .send(`No registrant found with given id : ${req.params.id}`);
  ...
  Registrant.findById(req.params.id, (err, doc) => {
    if (!err) {
      ...
      console.log(
        "Error in Retrieving Member :" + JSON.stringify(err, undefined, 2)
      );
    }
  });
};
...
module.exports.put = (req, res) => {
  if (!ObjectId.isValid(req.params.id))
    return res
      .status(400)
      .send(`No member found with given id : ${req.params.id}`);
  ...
  Registrant.findByIdAndUpdate(
    ...
    (err, doc) => {
      if (!err) {
        ...
        console.log(
          "Error in Member Update :" + JSON.stringify(err, undefined, 2)
        );
      }
    }
  );
...
module.exports.getRegIdCount = (req, res) => {
  Registrant.find({ regId: { $eq: req.params.regId } }, (err, docs) => {
    if (!err && docs.length > 0) {
      res.send({ message: "Registrant Code Successfully Verified" });
    } else {
      res.send({ message: "Registrant Code Not Valid" });
    }
  });
};
...
module.exports.delete = (req, res) => {
  ...
  Registrant.findByIdAndRemove(req.params.id, (err, doc) => {
    if (!err) {
      ...
      console.log(
        "Error in Retrieving Registrant :" + JSON.stringify(err, undefined, 2)
      );
    }
  });
};
